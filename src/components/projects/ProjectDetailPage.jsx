        ...
        {project.githubUrl && (
          <div className="flex justify-center mb-16">
            <a
              ...
              className="inline-flex items-center px-6 py-3 text-base font-medium rounded-md text-white bg-gray-900/60 backdrop-blur-3xl hover:bg-gray-800/70 border border-gray-700 hover:border-[#00e1ff] transition-all duration-300 group"
            >
