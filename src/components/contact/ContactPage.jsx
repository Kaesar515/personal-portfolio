    ...
    <div className="min-h-screen py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Information - Moved to be first (left side on large screens) */}
          <div className="space-y-8">
            {/* Box for Email/Location */}
          ...
          {/* Contact Form - Now second (right side on large screens) */}
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-lg p-8 border border-gray-800">
